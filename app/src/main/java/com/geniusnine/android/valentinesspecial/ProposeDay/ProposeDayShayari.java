 ...
 */
public class ProposeDayShayari extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] values = new String[] {"As days go by, my feelings get stronger\n" +
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(ProposeDayShayari.this,ProposeDayStatusQuotos.class);
